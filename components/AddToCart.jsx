  ...
  return (
    <div className='md:flex p-2'>
        ...
        <div className='mx-[50px]'>
            <p className='my-3 text-center md:ml-0 md:text-2xl font-bold'>Coperate Bag for Ladies</p>
            ...
            <div className='flex my-9'>
                ...
                <button className='text-blue-500 outline outline-blue-500 w-30 rounded-2xl py-1 ml-4'>Add to Cart</button>
            </div>
            {/* Delivery */}
